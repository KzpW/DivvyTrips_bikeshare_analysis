### CSV files are too large to upload to github.

# This is a fictional set of data set in Chicago, Illinois. It represents a study into the type of users that subscribe to a service vs the users who pay to use the servicen each time
...
# Casual riders tend to take longer and fewer rides per day, with average durations consistently over 40 minutes. 
# This behavior likely stems from leisure, tourism, and nightlife activities.
...
# Annual subscribers account for over 90% of trips, with average trip durations between 8–15 minutes. 
# This pattern is consistent with regular commuting behavior.
...
# The most common stations for starting trips are nearly identical to the most popular ending stations for casual riders,
# although riders typically do not return bikes to their starting location.

# ---- Peak Starting and Ending Hours ----

# Customers - Peak Start Hours
...
# Customers are more likely to start their rides later in the day compared to annual members.

# Customers - Peak End Hours
...
# Casual riders tend to end their trips between 4 pm and 6 pm, supporting the idea that their rides are often for leisure or tourism.

# Subscribers - Peak Start Hours
...
cat("\n---- Conclusion ----\n")
cat(
  "This report has analyzed Divvy bike-share data from Q1 2019 and Q1 2020 to understand how to convert casual riders into annual members.\n",
